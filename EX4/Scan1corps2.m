...
T1=table(variables(:,1),variables(:,2),'VariableNames',varNames,'RowNames',rowNames);
...
precision = logspace(-1,-7,nsimul); % Valeurs du parametre a scanner
